  ...
  echo $r2['name'] ?>
		...
		$can = $_POST['candidate'];
			...
			//{
				...
				//encrypt the student id with AES
				$enc_name = encrypt_decrypt('encrypt', $_SESSION["Admin_UserLogon"]);
				...
				echo $_SESSION["Admin_UserLogon"];
				 ...
				 if(!$vote1)
					...
					$sqlin = mysql_query("INSERT INTO votecount set Result = '1', studid = '".$enc_name."',Position='".$_POST['cat']."'");
					$admin="<meta http-equiv=\"Refresh\" content=\"0;url=./category.php\">";
					echo($admin); 
				}	
